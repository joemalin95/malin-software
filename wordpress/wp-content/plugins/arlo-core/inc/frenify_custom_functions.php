...
$attchments_options = array(
	'image_video_url' => array(
        'label'       => __( 'External Video Url', 'arlo' ),
        'input'       => 'text',
        'helps'       => __( 'Url from Youtube or Vimeo', 'arlo' ),
        'application' => 'image',
        'exclusions'  => array( 'audio', 'video' ),
    ),
);

class Arlo_Custom_Media_Fields {
...
$cmf = new Arlo_Custom_Media_Fields( $attchments_options );

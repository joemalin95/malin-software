...
class Frel_Plugin
{
    ...
    private function add_actions()
    {
		...
		add_action( 'elementor/editor/before_enqueue_scripts', function() {
			wp_enqueue_style( 'frel_elementor', ARLO_CORE_CSS . 'elementor.css', false, 1, 'all' );
		});
	...
	public function compare_core_and_theme() {
		if(wp_get_theme()->get('Name') == 'Arlo'){
			...
			if ( $my_theme->exists() ){
				...
				$pluginVersion 	= ARLO_CORE_VERSION;
				$arloCore		= 'Arlo Core';
    ...
    public function register_widget_scripts()
    {
		...
		wp_enqueue_script( 'frel_init_arlo', ARLO_CORE_JS . 'init-arlo.js', array( 'jquery' ), true, 1, 'all' );
		wp_enqueue_script( 'frel_init', ARLO_CORE_JS . 'init.js', array( 'jquery' ), true, 1, 'all' );
    ...
    public function register_widget_styles()
    {
		...
		wp_enqueue_style( 'frel_arlo_style', ARLO_CORE_CSS . 'style-arlo.css', false, 1, 'all' );
		wp_enqueue_style( 'frel_arlo_style_rtl', ARLO_CORE_CSS . 'style-rtl.css', false, 1, 'all' );
		wp_enqueue_style( 'frel_style', ARLO_CORE_CSS . 'style.css', false, 1, 'all' );
    }

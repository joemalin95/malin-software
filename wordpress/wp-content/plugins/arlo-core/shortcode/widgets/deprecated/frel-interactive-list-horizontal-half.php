 ...
 * Frel Site Title
 */
class Frel_Interactive_List_Horizontal_Half extends Widget_Base {

	public function get_name() {
		return 'frel-interactive-list-horizontal-half';
	}

	public function get_title() {
		return __( 'Interactive List Horizontal Half', 'frenify-core' );
	}

 ...
 * Frel Site Title
 */
class Frel_Interactive_List_Vertical_Full extends Widget_Base {

	public function get_name() {
		return 'frel-interactive-list-vertical-full';
	}

	public function get_title() {
		return __( 'Interactive List Vertical Full', 'frenify-core' );
	}
	...
	protected function render() {
		...
		$numberPosition		= $settings['number_position'];
		...
		if($items_type == 'custom'){
			if(!empty($list)){
				foreach($list as $key => $reg){
					...
					$image			= '<div class="main" data-bg-img="'.$reg['r_image']['url'].'">';
			...
			foreach ( $arlo_post_loop->posts as $key => $fn_post ) {
				...
				$image			= '<div class="main" data-bg-img="'.$post_image.'">';
				$galleryList .= '<li '.$active.'>'.$image.'</li>';
			...
			foreach ( $arlo_post_loop->posts as $key => $fn_post ) {
				...
				$image			= '<div class="main" data-bg-img="'.$post_img.'">';
				$galleryList .= '<li '.$active.'>'.$image.'</li>';

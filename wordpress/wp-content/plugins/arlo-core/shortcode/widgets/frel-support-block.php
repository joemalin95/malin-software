 ...
 * Frel Site Title
 */
class Frel_Support_Block extends Widget_Base {

	public function get_name() {
		return 'frel-support-block';
	}

	public function get_title() {
		return __( 'Support Block', 'frenify-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'desc',
			  [
				 ...
				 'default'     => __( 'Dont hesitate and lets get started! Contact us for a free quote on your next home improvement project.', 'frenify-core' ),
			  ]
		);
		$this->add_control(
			'link_url',
		...
		$this->add_control(
			'link_text',
			  [
				 ...
				 'default' 	   => __( 'Request an Estimate', 'frenify-core' ),
			  ]
		);
		...
		$this->add_control(
			'tall_free',
			  [
				 'label'       => __( 'Tall Free Text', 'frenify-core' ),
				 'type'        => Controls_Manager::TEXT,
				 'placeholder' => __( 'Type title here', 'frenify-core' ),
				 'default' 	   => __( 'Toll Free: 1-800-987-6543 ', 'frenify-core' ),
			  ]
		);
		$this->add_control(
			'image',
			[
				...
				'description' 	=> __( 'We suggest to use a png-image with dimensions 210x210', 'frenify-core' ),
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .bottom_section .link_block a',
				'fields_options' => [
					'font_weight' => [
						'default' => '500',
					],
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'tall_free_typography',
				'label' => __( 'Tall Free Typography', 'frenify-core' ),
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .bottom_section .tfree_block p',
				'fields_options' => [
					'font_weight' => [
						'default' => '400',
					],
		...
		$this->add_control(
			  ...
			  [
				 ...
				 'step'    => 1,
				 'selectors' => [
					'{{WRAPPER}} .support_block' => 'padding-top: {{VALUE}}px;',
				],
			  ]
		);
		...
		$this->add_control(
			  ...
			  [
				 ...
				 'step'    => 1,
				 'selectors' => [
					'{{WRAPPER}} .support_block' => 'padding-bottom: {{VALUE}}px;',
				],
			  ]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .support_block' => 'background-color: {{VALUE}};',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .support_block' => 'border-color: {{VALUE}};',
				],
				'default' => '#081225',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bottom_section .link_block a' => 'color: {{VALUE}};',
				],
				'default' => '#fff',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bottom_section .link_block a' => 'background-color: {{VALUE}};',
				],
				'default' => '#45a2df',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bottom_section .link_block a:hover' => 'color: {{VALUE}};',
				],
				'default' => '#fff',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bottom_section .link_block a:hover' => 'background-color: {{VALUE}};',
				],
				'default' => '#ad3110',
			]
		);
		$this->add_control(
			'tall_free_text_color',
			[
				'label' => __( 'Tall Free Text Color', 'frenify-core' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
				...
				'selectors' => [
					'{{WRAPPER}} .bottom_section .tfree_block p' => 'color: {{VALUE}};',
				],
				'default' => '#041230',
			]
		);
		$this->add_control(
			'tall_free_line_color',
			[
				'label' => __( 'Tall Free Line Color', 'frenify-core' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
				...
				'selectors' => [
					'{{WRAPPER}} .bottom_section div:nth-child(2):after' => 'background-color: {{VALUE}};',
				],
				'default' => '#999',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .img_wrap span' => 'border-right-color: {{VALUE}};',
				],
				'default' => '#ad3110',
			]
		);
	...
	protected function render() {
		...
		$tall_free 			= $settings['tall_free'];
		$desc 				= $settings['desc'];
		$icon_type 			= $settings['icon_type'];
		$frenify_icons 		= $settings['frenify_icons'];
		$elementor_icons 	= $settings['elementor_icons'];
		$image 				= $settings['image']['url'];
		$html 				= do_shortcode('[frenify_support_block link_text="'.$link_text.'" tall_free="'.$tall_free.'" desc="'.$desc.'" link_url="'.$link_url.'" icon_type="'.$icon_type.'" image="'.$image.'" elementor_icons="'.$elementor_icons.'" frenify_icons="'.$frenify_icons.'"]');
		echo $html;
	}

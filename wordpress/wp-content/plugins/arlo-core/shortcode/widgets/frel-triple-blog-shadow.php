...
class Frel_Triple_Blog_Shadow extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'blog_style',
			[
				'label' => __( 'Blog Style', 'frenify-core' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default'  		=> __( 'Default', 'frenify-core' ),
					'another'  		=> __( 'Another', 'frenify-core' ),
				],
			]
		);
	...
	protected function render() {
		...
		$html .= '<div class="fn_cs_triple_blog_shadow '.$dark_mode.'" data-style="'.$blog_style.'">'.$fnC_Start.'<div class="inner">';
		$has_img 		= '';
		$posts_part		= '<ul>';
		$callBackImg 	= '<img src="'.ARLO_CORE_SHORTCODE_URL.'assets/img/thumb-370-250.jpg" alt="" />';
